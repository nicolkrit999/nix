...
delib.module {
  ...
  home.ifEnabled =
    ...
    in
    {
      catppuccin.alacritty.enable = config.nixos.constants.theme.catppuccin or false;
      catppuccin.alacritty.flavor = config.nixos.constants.theme.catppuccinFlavor or "mocha";
