...
lib.mkIf ((vars.shell or "zsh") == "fish") {
  programs.fish = {
    ...
    in {
      ...
      swdry =
        "cd ${flakeDir} && nh os test --dry --ask"; # Dry run of nixos-rebuild switch
