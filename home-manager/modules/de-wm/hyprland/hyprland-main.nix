    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        env =
          ...
          in
          [
            # Forces Electron apps (VS Code, Discord, Obsidian) to run natively on Wayland.
            "NIXOS_OZONE_WL,1"
            ...
            # THEMING & AESTHETICS
            "QT_QPA_PLATFORMTHEME,kde" # Tells Qt apps to use the 'qt5ct' or 'qt6ct' tool for styling (fixes ugly Qt apps).
