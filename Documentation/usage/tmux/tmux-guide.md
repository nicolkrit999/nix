...
| :---------------------------- | :------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------- |
| **Create separate workspace** | **1.** Open Terminal (Auto-joins "main")<br>**2.** Detach (`Ctrl`+`b`, `d`)<br>**3.** Run `tmux new -s side-project` | Keeps your "Side Project" windows completely separate from your "Main" work.                       |
