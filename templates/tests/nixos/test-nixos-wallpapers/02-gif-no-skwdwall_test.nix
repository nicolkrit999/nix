# W02 - x86_64, mixed static+gif wallpaper, skwdWall disabled
...
nix-tests.runTests {
  "W02: x86_64 gif+static wallpaper, skwdWall disabled" = helpers: {
    ...
    "niri spawn does NOT contain awww img" =
      helpers.isFalse (H.niriSpawnHas "awww img" config); # GNOME always uses the static wallpaperURL (gifURL is WM-only)
