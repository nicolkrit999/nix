# Named-monitor variant with videoURL set - verifies mpvpaper's -o flag
# resolves to the explicit monitor name (not "ALL") when targetMonitor is set.
{
  ...
  wallpapers = [
    {
      ...
      videoSHA256 = "04nvv7qaq03rdaqwyydnn9xkyfnxi3k0x8n45kwaqg2s3xdmkx8y";
    }
  ];
  theme = {
    polarity = "dark";
