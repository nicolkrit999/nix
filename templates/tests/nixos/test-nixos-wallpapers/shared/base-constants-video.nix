# Base constants for wallpaper tests that set both wallpaperURL and videoURL.
# Tests the video-priority path: WMs use the VIDEO (via mpvpaper), DEs/stylix use the static URL.
{
  ...
  wallpapers = [
    {
      ...
      gifURL = "";
      gifSHA256 = "";
      videoURL = "https://gitea.nicolkrit.ch/krit/wallpapers-repo/raw/branch/main/various/other-user-github-repos/video/loop.mp4";
      videoSHA256 = "11v0dig4sxgdkms5w4iyfgj55h6gxn24pvg3bl8qg1g1avi220rm";
    }
  ];
  theme = {
    polarity = "dark";
