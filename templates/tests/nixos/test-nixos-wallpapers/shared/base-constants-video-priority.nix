# Base constants for wallpaper tests that set wallpaperURL, gifURL AND videoURL
# together. Tests the full priority chain: video > gif > static.
{
  ...
  wallpapers = [
    {
      ...
      videoSHA256 = "1clxw5gfii22cnc0hfccbp29g9q92v495646ibx3wq490h0ld908";
    }
  ];
  theme = {
    polarity = "dark";
